...
*/
func (a *SystemCompatApiService) CompatSystemVersion(ctx context.Context) (InlineResponse20014, *http.Response, error) {
	var (
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *SystemCompatApiGetEventsOpts - Optional Parameters:
...
type SystemCompatApiGetEventsOpts struct {
    Since optional.String
    Until optional.String
    Filters optional.String
}

func (a *SystemCompatApiService) GetEvents(ctx context.Context, localVarOptionals *SystemCompatApiGetEventsOpts) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
...
*/
func (a *SystemCompatApiService) GetInfo(ctx context.Context) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
...
@return string
*/
func (a *SystemCompatApiService) LibpodPingGet(ctx context.Context) (string, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
