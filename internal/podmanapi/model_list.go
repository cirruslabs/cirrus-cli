...
// Callers can either use this abstract interface without understanding the details of the formats, or instantiate a specific implementation (e.g. manifest.OCI1Index) and access the public members directly.
type List struct {
	Clone *List `json:"Clone,omitempty"`
	// Instances returns a list of the manifests that this list knows of, other than its own.
	Instances []Digest `json:"Instances,omitempty"`
