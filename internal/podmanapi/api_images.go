...
func (a *ImagesApiService) LibpodExportImage(ctx context.Context, name_ string, localVarOptionals *ImagesApiLibpodExportImageOpts) (string, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
...
func (a *ImagesApiService) LibpodExportImages(ctx context.Context, localVarOptionals *ImagesApiLibpodExportImagesOpts) (string, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
...
func (a *ImagesApiService) LibpodImagesImport(ctx context.Context, upload *os.File, localVarOptionals *ImagesApiLibpodImagesImportOpts) (ImageImportReport, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
...
func (a *ImagesApiService) LibpodImagesLoad(ctx context.Context, upload *os.File, localVarOptionals *ImagesApiLibpodImagesLoadOpts) (ImageLoadReport, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
...
func (a *ImagesApiService) LibpodPushImage(ctx context.Context, name_ string, localVarOptionals *ImagesApiLibpodPushImageOpts) (string, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
