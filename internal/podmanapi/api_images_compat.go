 ...
 * @param optional nil or *ImagesCompatApiCreateImageOpts - Optional Parameters:
     ...
     * @param "Request" (optional.String) -  Image content if fromSrc parameter was used
...
@return string
*/
func (a *ImagesCompatApiService) ExportImage(ctx context.Context, name_ string) (string, *http.Response, error) {
	var (
 ...
 * @param optional nil or *ImagesCompatApiImportImageOpts - Optional Parameters:
     ...
     * @param "Request" (optional.String) -  tarball of container image
...
func (a *ImagesCompatApiService) PushImage(ctx context.Context, name_ string, localVarOptionals *ImagesCompatApiPushImageOpts) (string, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
