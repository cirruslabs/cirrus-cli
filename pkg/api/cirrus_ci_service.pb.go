...
func file_api_cirrus_ci_service_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_api_cirrus_ci_service_proto_msgTypes[94].Exporter = func(v any, i int) any {
		...
		file_api_cirrus_ci_service_proto_msgTypes[98].Exporter = func(v any, i int) any {
	...
	file_api_cirrus_ci_service_proto_msgTypes[58].OneofWrappers = []any{
		(*CacheRetrievalAttempt_Hit_)(nil),
		(*CacheRetrievalAttempt_Miss_)(nil),
	}
	file_api_cirrus_ci_service_proto_msgTypes[65].OneofWrappers = []any{
	...
	file_api_cirrus_ci_service_proto_msgTypes[72].OneofWrappers = []any{
		(*FileInstruction_FromEnvironmentVariable)(nil),
		(*FileInstruction_FromContents)(nil),
	}
	file_api_cirrus_ci_service_proto_msgTypes[81].OneofWrappers = []any{
		(*Isolation_None_)(nil),
	...
	file_api_cirrus_ci_service_proto_msgTypes[121].OneofWrappers = []any{
